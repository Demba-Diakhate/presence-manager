        ...
        <div>
            ...
            <!-- <nav> -->
                <!-- <ul class="flex justify-center items-center gap-5 text-white"> -->
                    <ul class="flex flex-row justify-center items-center gap-5 text-white md:flex md:justify-center md:items-center md:gap-5 md:flex-row">
                        ...
                        <li class="flex items-center justify-center text-white bg-cyan-700 border border-cyan-700 hover:ring-2 hover:ring-cyan-500 font-semibold rounded text-sm px-8 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-fuchsia-500"><a href="addStudents.php">Ajouter</a></li>
                    </ul>
                <!-- </nav> -->
            </div>
            ...
            <div class="z-50 -mt-1 pb-3 py-auto pt-3 md:z-0 md:pt-0 md:pl-0 md:pb-0 md:mt-0 md:-mr-0 bg-fuchsia-900 md:bg-inherit hidden md:hidden w-full md:w-auto md:order-1" id="navbar-user">
                    <ul class="flex flex-col justify-center items-center gap-5 text-white md:flex md:justify-center md:items-center md:gap-5 md:flex-row">
                        <li class="font-semibold w-5/12 flex items-center justify-center <?= $currentPage === 'showStudents.php' ? 'bg-fuchsia-500 border border-fuchsia-500 text-white' : ' text-white'?> px-4 py-2 rounded hover:ring-2 hover:ring-fuchsia-500"><a href="showStudents.php">Liste apprenants</a></li>
                        <li class="font-semibold w-5/12 flex items-center justify-center <?= $currentPage === 'historyAttendance.php' ? ' text-white' : 'bg-fuchsia-800 border border-fuchsia-800 text-white'?> px-4 py-2 rounded hover:bg-fuchsia-700 hover:ring-2 hover:ring-fuchsia-500"><a href="historyAttendance.php">Historique de présence</a></li>
                        <li class="flex items-center justify-center w-5/12 text-white bg-cyan-700 border border-cyan-700 hover:ring-2 hover:ring-cyan-500 font-semibold rounded text-sm px-8 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-fuchsia-500"><a href="addStudents.php">Ajouter</a></li>
                    </ul>
            </div>
